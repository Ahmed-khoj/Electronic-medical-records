...
contract myToken is ERC20 {
    ...
    string public constant name = "emrToken"; 
    string public constant  symbol = "EMR";
...
modifier higherThanZero(uint256 _uint) {
 ...
 function giveAccessToIns(address insurance) public {
  ...
  function setemrTokenReward(uint256 _tokenReward) private OnlyOwner higherThanZero(_tokenReward)
    {
