...
import metaCoinArtifact from "/Users/aak/Desktop/EMR/build/contracts/EMR.json";
...
const App = {
  ...
  addpatient: async function() {
    ...
    this.setStatus("Success!! The information has been stored in blockchain " + this.account );
  },
